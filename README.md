...
- **Осмичен:** Пресметки и прикажување во осмичен бројен систем.

### Историјат на Пресметки

- **Преглед на Историјат:** Корисниците можат да го прегледуваат историјатот на извршени пресметки.
- **Чистење на Историјат:** Можност за чистење на историјатот на пресметки.
